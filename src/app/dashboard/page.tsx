      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-8 items-start">
        ...
        <aside className="flex flex-col gap-6 xl:sticky xl:top-20">
          ...
          <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-4 flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-[#d29922]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <h3 className="text-sm font-bold text-white">Match Tip</h3>
            </div>
            <p className="text-xs text-gray-400 leading-relaxed">{matchTip}</p>
          </div>
        </aside>
      </div>
